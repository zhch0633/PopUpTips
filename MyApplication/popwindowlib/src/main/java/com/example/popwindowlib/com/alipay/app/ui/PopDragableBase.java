 ...
 */
public class PopDragableBase extends PopupWindow implements View.OnTouchListener ,PopFollower{
    ...
    private  int afterDragX;

    private  int beforeDragY;
    private  int afterDragY;
